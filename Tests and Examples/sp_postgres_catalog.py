...
#sdf = dbconn.get_sdf_for_table(sdf_name, dataset_schema, dataset_table, key_column, fit_schema, default_order_by, None, **db_args)
#sdf = dbconn.get_sdf_for_table(sdf_name, dataset_schema, dataset_table, key_column, fit_schema, default_order_by)
#sdf = dbconn.get_sdf_for_table(sdf_name, dataset_schema, dataset_table, key_column, fit_schema, default_order_by)
sdf = dbconn.get_sdf_for_table(sdf_name, dataset_schema, dataset_table, key_column)
print(sdf.catalog)
print(sdf.catalog.get_list_of_tables())
print(sdf)
...
print(x_train_sdf.catalog)
print(x_test_sdf.catalog)
print(x_train_sdf.catalog.get_list_of_tables())
...
print(sdf2.catalog.get_list_of_tables())

# view of both sdfs catalog records
print(sdf2.catalog.get_list_of_tables(include_all_sdfs=True))
...
sdf.catalog.drop_temporary_tables()
print(sdf.catalog.get_list_of_tables(include_all_sdfs=True))
